...
//     while (hasMore) {
//       try {
//         const pendingTransactions = await db.transaction(async (tx) => {
//           return await tx
//             .select()
...
//             .for('update', { of: payinTransactions, skipLocked: true });
//         });
...
//             } else {
//               log.info(`Transaction ${transaction.uniqueId} was already processed`);
//             }
//           } catch (error) {
