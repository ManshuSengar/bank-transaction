...
i want some fixes first that if email already exist user cannot save form and other then if possible use Enchanced dropdown instead of multiple pnfDrop with same functionality and give me complete and proper code
